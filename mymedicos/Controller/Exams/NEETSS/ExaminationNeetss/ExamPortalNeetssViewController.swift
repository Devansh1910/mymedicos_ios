...
class ExamPortalNeetssViewController: UIViewController, QuestionNavigatorDelegate {
    ...
    private func fetchQuestions() {
        ...
        let documentRef = db.collection("Fmge").document("CWT").collection("Quiz").document(examID)
