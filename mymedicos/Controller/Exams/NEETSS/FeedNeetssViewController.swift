...
class FeedNeetssViewController: UIViewController, UIScrollViewDelegate {
    
    var phoneNumber: String?
    var heroImageView: HeroImageNeetssUIView!
    var overlayView: OverlayNeetssUIView!
    ...
    private func setupHeroImageView() {
        heroImageView = HeroImageNeetssUIView(frame: CGRect.zero, title: examCategory)
    ...
    private func setupOverlayView() {
        overlayView = OverlayNeetssUIView(frame: CGRect.zero)
