...
class CWTNeetssViewController: UIViewController, UITableViewDataSource, QuizTableViewCellDelegate, BottomSheetDelegate {
    ...
    func fetchQuizData() {
        ...
        fetchNeetssValue { [weak self] neetssValue in
            ...
            var query: Query = quizCollection.whereField("speciality", isEqualTo: self.specialtyTitle)
