...
class SWGTNeetssViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, ExamQuizLiveTableViewCellDelegate, BottomSheetDelegate, SWGTUpcomingBottomSheetDelegate {
    ...
    func fetchLiveQuizzes() {
        ...
        let quizCollection = db.collection("Fmge").document("CWT").collection("Quiz")
