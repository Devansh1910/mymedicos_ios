...
class GrandTestExamNeetssPortalViewController: UIViewController, GrandTestNavigatorDelegate {
    ...
    private func fetchQuestions() {
        ...
        let documentRef = db.collection("Fmge").document("Weekley").collection("Quiz").document(examID)
