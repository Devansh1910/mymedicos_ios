...
protocol QuestionNavigatorDelegate: AnyObject {
    func didSelectQuestion(at index: Int)
    func didDismissQuestionNavigator()
}

class QuestionNavigatorViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    init(questions: [Question], delegate: QuestionNavigatorDelegate) {
