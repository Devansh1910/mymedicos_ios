...
class NeetInsiderTabbarViewController: UITabBarController {
    
    init(title: String) {
        super.init(nibName: nil, bundle: nil)
        
        let vc1 = UINavigationController(rootViewController: IndexViewController(title: title))
        let vc2 = UINavigationController(rootViewController: CWTViewController(title: title))
        let vc3 = UINavigationController(rootViewController: SWGTViewController(title: title))
