...
protocol ResultGrandTestBottomSheetDelegate: AnyObject {
    func didSetReminder(forExamID examID: String)
}

class ResultGrandTestBottomSheetViewController: UIViewController {
    var examID: String?
    weak var delegate: ResultGrandTestBottomSheetDelegate?
