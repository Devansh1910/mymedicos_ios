...
class ExamInfoViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        let examDetailsView = ExamInfoUIView()
    ...
    @objc private func startTest() {
        ...
        examPortalVC.examTitle = examTitle // Pass the title dynamically
        examPortalVC.examID = examID // Pass the examID dynamically
