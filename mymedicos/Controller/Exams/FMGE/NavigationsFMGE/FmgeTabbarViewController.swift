...
class FmgeTabbarViewController: UITabBarController {
    
    var titleExaminationCategory: String?
    
    private var heroImageView: HeroImageFmgeUIView!
    ...
    override func viewDidLoad() {
        ...
        let vc1 = UINavigationController(rootViewController: FeedFmgeViewController())
        let vc2 = UINavigationController(rootViewController: PreparationFmgeViewController())
        let vc3 = UINavigationController(rootViewController: GrandTestFmgeViewController())
    ...
    private func setupHeroImageView() {
        ...
        heroImageView = HeroImageFmgeUIView(frame: frame, title: self.title ?? "Default Title")
