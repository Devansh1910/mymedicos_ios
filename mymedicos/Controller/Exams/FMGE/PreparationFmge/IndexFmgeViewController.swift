...
class IndexFmgeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIViewControllerTransitioningDelegate {
    ...
    private func fetchIndexData() {
        ...
        let documentPath = "Fmge/Indexs/Index/\(specialtyTitle)"
