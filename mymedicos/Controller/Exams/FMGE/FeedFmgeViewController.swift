...
class FeedFmgeViewController: UIViewController, UIScrollViewDelegate {
    
    var phoneNumber: String?
    var heroImageView: HeroImageFmgeUIView!
    var overlayView: OverlayFmgeUIView!
    ...
    private func setupHeroImageView() {
        heroImageView = HeroImageFmgeUIView(frame: CGRect.zero, title: examCategory)
    ...
    private func setupOverlayView() {
        overlayView = OverlayFmgeUIView(frame: CGRect.zero)
