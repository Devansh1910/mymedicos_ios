...
class ExamFmgeDetailsUIView: UIView {
    ...
    private func setupUI() {
        ...
        let durationView = createDetailView(imageName: "calendar.circle.fill", title: "210 Mins", subtitle: "Duration")
        
        // Setting up Scoring Details view
        let scoringView = createDetailView(imageName: "newspaper.circle.fill", title: "200 Questions • 800 Marks", subtitle: "Scoring details")
        ...
        let stackView = UIStackView(arrangedSubviews: [durationView, scoringView, markingView, languageView])
