...
protocol PreparationQuestionsNavigationQuestionNavigatorDelegate: AnyObject {
    func didSelectQuestion(at index: Int)
    func didDismissQuestionNavigator()
}

class PreparationQuestionNavigatorViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {

    private var questions: [QuestionPrep]
    private var collectionView: UICollectionView!
    weak var delegate: QuestionNavigatorDelegate?
    ...
    init(questions: [QuestionPrep], delegate: QuestionNavigatorDelegate) {
